...
# Sample JSON data for testing
#Do not forget to add access-token the following JSON data in postman
'''
{
  "coupon_code": "NY-2025",
  "amount": "1000.00"
...
class PlaceOrderView(APIView):
    def post(self, request):
        ...
        if coupon_code:
            # Instead of calling ApplyCouponView.post directly (not good), refactor coupon logic into a helper function
            # For simplicity, let's simulate a helper function:
            from .utils import apply_coupon_discount  # you should create this helper

            coupon_result = apply_coupon_discount(user=user, coupon_code=coupon_code, amount=total_amount,
