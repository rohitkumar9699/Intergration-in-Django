...
SECRET_KEY = 'django-insecure-@ime)z05p$6_7m@u0=5bz2e72h2!8g0(wep3!g^&f0^8pj(m_r'
...
INSTALLED_APPS = [
    ...
    # 'rest_framework_simplejwtuserManagement',
    'userManagement',
    'project',
    'coupons',
    'blog',
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,  # You can change to any number
